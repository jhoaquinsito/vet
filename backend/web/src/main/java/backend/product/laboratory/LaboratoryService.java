...
public class LaboratoryService {
	...
	public LaboratoryService() {
		super();
		// obtengo el repositorio desde el contexto de la applicaciÃ³n
	...
	/**
	 * MÃ©todo que permite guardar laboratorios. Puede ser un laboratorio nuevo (creación) o
	...
	public Laboratory save(Laboratory pLaboratoryToSave) throws BusinessException {
		// Valido si el producto tiene datos vÃ¡lidos
	...
	private void validate(Laboratory pLaboratory) throws BusinessException{
		...
		if(!this.getByName(pLaboratory.getName()).isEmpty()){
			throw new BusinessException("LaboratoryService","Laboratory no válido", "validate",  friendlyMessage + " Ya existe un laboratorío bajo el mismo nombre ( " + pLaboratory.getName() + " )", HttpStatus.CONFLICT);
		}
